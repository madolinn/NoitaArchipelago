...
return {
	...
	[110161] = { perk = "AP_SOUL_BOSS_DRAGON", soul = "Suomuhauki", redeliverable = true, newgame = true },
	[110162] = { perk = "AP_SOUL_BOSS_LIMBS", soul = "Kolmisilmän Koipi", redeliverable = true, newgame = true },
	[110163] = { perk = "AP_SOUL_BOSS_MEAT", soul = "Kolmisilmän sydän", redeliverable = true, newgame = true },
	[110164] = { perk = "AP_SOUL_BOSS_ALCHEMIST", soul = "Ylialkemisti", redeliverable = true, newgame = true },
	[110165] = { perk = "AP_SOUL_PARALLEL_ALCHEMIST", soul = "Alkemistin Varjo", redeliverable = true, newgame = true },
	[110166] = { perk = "AP_SOUL_BOSS_GHOST", soul = "Unohdettu", redeliverable = true, newgame = true },
	[110167] = { perk = "AP_SOUL_BOSS_GHOST_POLYP", soul = "Häive", redeliverable = true, newgame = true },
	[110168] = { perk = "AP_SOUL_ISLANDSPIRIT", soul = "Tapion vasalli", redeliverable = true, newgame = true },
	[110169] = { perk = "AP_SOUL_BOSS_PIT", soul = "Sauvojen tuntija", redeliverable = true, newgame = true },
	[110170] = { perk = "AP_SOUL_BOSS_ROBOT", soul = "Kolmisilmän silmä", redeliverable = true, newgame = true },
	[110171] = { perk = "AP_SOUL_FISH_GIGA", soul = "Syväolento", redeliverable = true, newgame = true },
	[110172] = { perk = "AP_SOUL_MAGGOT_TINY", soul = "Limatoukka", redeliverable = true, newgame = true },
	[110173] = { perk = "AP_SOUL_PARALLEL_TENTACLES", soul = "Kolmisilmän Kätyri", redeliverable = true, newgame = true },
	[110174] = { perk = "AP_SOUL_GATE_GUARDIAN", soul = "Gate Guardian", redeliverable = true, newgame = true },

	[110178] = { perk = "AP_SOUL_BOSS_WIZARD", soul = "Mestarien mestari", redeliverable = true, newgame = true },
	[110179] = { perk = "AP_SOUL_BOSS_CENTIPEDE", soul = "Kolmisilmä", redeliverable = true, newgame = true },
	[110180] = { perk = "AP_SOUL_ULTIMATE_KILLER", soul = "Kauhuhirviö", redeliverable = true, newgame = true },
	[110181] = { perk = "AP_SOUL_FRIEND", soul = "Toveri", redeliverable = true, newgame = true },
	[110182] = { perk = "AP_SOUL_BOSS_SKY", soul = "Kivi", redeliverable = true, newgame = true },
